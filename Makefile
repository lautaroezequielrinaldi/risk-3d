...
CLIENT_TARGET: $(OBJECT_CLIENT_FILES)
	$(CXX) $(CXXFLAGS) $(CLIENTCFLAGS) $(LDFLAGS) $(CLIENTLIB) $(OBJECT_CLIENT_FILES) $(LOADLIBS) $(LDLIBS) -o $(CLIENT_DIR)/$(target_client)

EDITOR_TARGET: $(OBJECT_EDITOR_FILES)
	$(CXX) $(CXXFLAGS) $(EDITORCFLAGS) $(LDFLAGS) $(EDITORLIB) $(OBJECT_EDITOR_FILES) $(LOADLIBS) $(LDLIBS) -o $(EDITOR_DIR)/$(target_editor)

SERVER_TARGET: $(OBJECT_SERVER_FILES)
	$(CXX) $(CXXFLAGS) $(SERVERCFLAGS) $(LDFLAGS) $(SERVERLIB) $(OBJECT_SERVER_FILES) $(LOADLIBS) $(LDLIBS) -o $(SERVER_DIR)/$(target_server)
