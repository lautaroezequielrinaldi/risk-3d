...
UNITTEST_SOURCES_AUX1 ?= $(filter-out $(CLIENT_DIR)/$(target_client).$(FILE_EXTENSION),$(ALL_UNITTEST_SOURCES))

UNITTEST_SOURCES_AUX2 ?= $(filter-out $(EDITOR_DIR)/$(target_editor).$(FILE_EXTENSION),$(UNITTEST_SOURCES_AUX1))

UNITTEST_SOURCES ?= $(filter-out $(SERVER_DIR)/$(target_server).$(FILE_EXTENSION),$(UNITTEST_SOURCES_AUX2))
...
OBJECT_UNITTEST_FILES = $(patsubst %.$(FILE_EXTENSION),%.*,$(UNITTEST_SOURCES))
